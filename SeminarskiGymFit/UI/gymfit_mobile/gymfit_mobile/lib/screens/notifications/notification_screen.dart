...
void loadNotifications() async {
    try {
NotificationsSearchObject searchObject  =  NotificationsSearchObject(userId: _userId);
...
int countUnreadNotifications() {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return buildNotificationItem(notifications[index].content);
                  },
                ),
              ),
              Padding(
  ...
  Widget buildNotificationItem(String content) {
    return Container(
